  ...
  if (provider.defaultSource === 'old.genios.de') {
    login = [
      [
        {
          fill: {
            selector: '#bibLoginLayer_externalAuthId',
            value: provider.bibId,
          },
        },
        {
          fill: {
            selector: '#bibLoginLayer_number',
            providerKey: provider.id + '.options.username',
          },
        },
        {
          fill: {
            selector: '#bibLoginLayer_password',
            providerKey: provider.id + '.options.password',
          },
        },
...
const providers: Providers = {
  ...
  'www.duesseldorf.de': {
    ...
    params: {
      'www.nexisuni.com': {
        ...
        startUrl:
          'http://ezp-lhd.itk-rheinland.de:2048/login?url=https://www.nexisuni.com',
      },
    },
    ...
    permissions: ['https://*.ezp-lhd.itk-rheinland.de/*'],
  },
  'fernuni-hagen.de': {
    name: 'FernUni Hagen',
    ...
    login: [
      [
        { message: 'Bibliothekskonto wird eingeloggt...' },
        {
          fill: {
            selector: 'input[name="user"]',
            providerKey: 'fernuni-hagen.de.options.username',
          },
        },
        {
          fill: {
            selector: 'input[name="pass"]',
            providerKey: 'fernuni-hagen.de.options.password',
          },
        },
        { click: 'input[type="submit"]' },
      ],
    ...
    permissions: ['https://*.ub-proxy.fernuni-hagen.de/*'],
  },
  'www.slub-dresden.de': {
      ...
      [
        { message: 'Bibliothekskonto wird eingeloggt...' },
        {
          fill: {
            ...
            providerKey: 'www.slub-dresden.de.options.username',
          },
        },
        {
          fill: {
            selector: 'input[name="j_password"]',
            providerKey: 'www.slub-dresden.de.options.password',
          },
        },
        { click: 'input[type="submit"]' },
      ],
    ...
    permissions: ['https://login.slub-dresden.de/*'],
  },
  'www.bsb-muenchen.de': {
      ...
      [
        {
          fill: {
            selector: 'input[name="username"]',
            providerKey: 'www.bsb-muenchen.de.options.username',
          },
          optional: true,
        },
        {
          fill: {
            selector: 'input[name="password"]',
            providerKey: 'www.bsb-muenchen.de.options.password',
          },
          optional: true,
        },
    ...
    permissions: ['https://*.bsb-muenchen.de/*'],
  },
  'wiso-net.de': {
    ...
    login: [
      [
        ...
        {
          fill: {
            selector: 'input[name="loginBlock.username"]',
            providerKey: 'wiso-net.de.options.username',
          },
        },
        {
          fill: {
            selector: 'input[name="loginBlock.password"]',
            providerKey: 'wiso-net.de.options.password',
          },
        },
        { click: '#loginBlock_c1' },
      ],
  ...
  'sso.wiso-net.de': {
    ...
    login: [
      [
        ...
        {
          fill: {
            selector: '#shibbolethForm_selectedCity',
            providerKey: 'sso.wiso-net.de.options.city',
          },
        },
        {
  ...
  'www.lib.bonn.de': {
    ...
    permissions: ['https://*.bonn.idm.oclc.org/*'],
  },
  'stadt-koeln.de': {
    ...
    params: {
      'www.nexisuni.com': {
        ...
        startUrl:
          'https://ezproxy.stadt-koeln.de/login?url=https://www.nexisuni.com',
      },
    },
    defaultSource: 'www.nexisuni.com',
    login: [
    ...
    permissions: ['https://*.ezproxy.stadt-koeln.de/*'],
  },
  'www.aachen.de': {
    ...
    params: {
      'www.nexisuni.com': {
        ...
        startUrl:
          'https://login.stb-aachen.idm.oclc.org/login?qurl=https%3a%2f%2fwww.nexisuni.com',
      },
    },
    defaultSource: 'www.nexisuni.com',
    login: [
    ...
    permissions: ['https://*.stb-aachen.idm.oclc.org/*'],
  },
  'www.dortmund.de': {
    ...
    params: {
      'www.nexisuni.com': {
        ...
        startUrl:
          'https://go.openathens.net/redirector/dortmund.de?url=http://www.nexisuni.com+',
      },
    },
    defaultSource: 'www.nexisuni.com',
    login: [
  ...
  'www.wuppertal.de': {
    ...
    params: {
      'www.nexisuni.com': {
        ...
        startUrl:
          'https://login.webopac.wuppertal.de:1443/login?qurl=https%3a%2f%2fwww.nexisuni.com',
      },
    },
    defaultSource: 'www.nexisuni.com',
    login: [
