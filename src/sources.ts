...
const sources: Sources = {
  'www.munzinger.de': {
    ...
    start:
      'https://{source.domain.raw}/search/go/spiegel/aktuell.jsp?portalid={source.portalId}',
    defaultParams: {
  ...
  'genios.de': {
    loggedIn:
      ':is(#header__login[auth=true], #header__login__buttons > button:nth-child(4))',
    ...
    search: [
      [
        { message: 'Artikel wird gesucht...' },
        {
          url: (articleInfo: ArticleInfo, sourceParams: SiteSourceParams) => {
            ...
            sourceParams.sourceNames?.forEach((sourceName) => {
      ...
      [
        ...
        {
          failOnMissing: '.tooltip.article__text__title',
          failure: 'Artikel nicht gefunden',
        },
        {
      ...
      [
        ...
        {
          extract: '#content pre.text, .divDocument pre.textCompact',
          convert: 'preToParagraph',
        },
      ],
    ],
  },
  'old.genios.de': {
    ...
    search: [
      ...
      [
        { captcha: '#layer_captcha' },
        {
          extract: '.divDocument pre.text, .divDocument pre.textCompact',
          convert: 'preToParagraph',
        },
      ],
    ],
